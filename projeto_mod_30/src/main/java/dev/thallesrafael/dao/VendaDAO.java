...
import main.java.dev.thallesrafael.dao.factory.ProdutoQuantidadeFactory;
import main.java.dev.thallesrafael.dao.factory.VendaFactory;
import main.java.dev.thallesrafael.dao.generic.GenericDAO;
import main.java.dev.thallesrafael.domain.ProdutoQuantidade;
...
import static main.java.dev.thallesrafael.domain.Venda.Status.CONCLUIDA;
...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    public void finalizarVenda(Venda venda) throws TipoChaveNaoEncontradaException, DAOException {
        ...
        try {
            ...
            stm.setString(1, CONCLUIDA.name());
