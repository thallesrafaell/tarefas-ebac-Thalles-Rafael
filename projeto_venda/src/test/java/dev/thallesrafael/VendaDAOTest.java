...
import main.java.dev.thallesrafael.dao.*;
...
public class VendaDAOTest {
	...
	private Cliente cadastrarCliente() throws TipoChaveNaoEncontradaException {
		...
		cliente.setCPF(3123315345234L);
		cliente.setNome("Thalles Rafael");
		cliente.setCidade("asdfasdfasdfaso");
		cliente.setEndereco("asdfasdfsd");
		cliente.setEstado("mg");
		cliente.setNumero(10);
		cliente.setTel(136543645L);
